                            ...
                            <Card className={classes.card} square={true}>
                                <CardContent className={classes.insideCard}>
                                    <Box className={classes.topCard}>
                                        ...
                                        <Typography color='primary' className={classes.price}>$10</Typography>
                                        <Typography color='primary' className={classes.year}>per month</Typography>
                                    </Box>
                            ...
                            <Card className={classes.card} square={true}>
                                <CardContent className={classes.insideCard}>
                                    <Box className={classes.topCard}>
                                        ...
                                        <Typography color='secondary' className={classes.price}>$20</Typography>
                                        <Typography color='secondary' className={classes.year}>per month</Typography>
                                    </Box>
                                    <Box className={classes.centerCard}>
                                        <Typography className={classes.centerText}><FaRegCheckCircle className={classes.icon} />Page examples</Typography>
                                        <Typography className={classes.centerText}><FaRegCheckCircle className={classes.icon} />Friendly support team</Typography>
                    ...
                    <Grid item xs={12} sm={12} md={4} style={{ display: "flex", justifyContent: "center" }}>
                        <Box>
                            <Card className={classes.card} square={true}>
                                <CardContent className={classes.insideCard}>
                                    <Box className={classes.topCard}>
                                        <Typography className={classes.plan3}>Premium</Typography>
                                        <Typography className={classes.price3}>$30</Typography>
                                        <Typography className={classes.year3}>per month</Typography>
                                    </Box>
                                    <Box className={classes.centerCard}>
                                        <Typography className={classes.centerText}><FaRegCheckCircle className={classes.icon} />Page examples</Typography>
                                        <Typography className={classes.centerText}><FaRegCheckCircle className={classes.icon} />Friendly support team</Typography>
